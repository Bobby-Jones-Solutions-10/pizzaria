                ...
                <tbody class="bg-zinc-100">
                    ...
                    foreach ($info as $key => $value) {
                        ...
                        <tr>
                            ...
                            <th>
                                <a href="<?php echo INCLUDE_PATH; ?>/Sabor?id=<?php echo $value['id']; ?>">
