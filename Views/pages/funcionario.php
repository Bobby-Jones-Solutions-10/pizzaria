        ...
        <div class="w-full flex flex-col items-center mt-10">
            ...
            <form action="" method="post" class="w-[800px] grid grid-cols-12 gap-2">
                ...
                <input type="text" required name="bairro" placeholder="Bairro" id="bairro"
                    class="bg-white border rounded-md p-2 text-md font-bold text-zinc-600 col-span-4" value="<?php echo ($info != null) ? $info[0]['bairro'] : null ?>"/>
                ...
                <select name="cargo" id="" class="bg-white border rounded-md p-2 text-md font-bold col-span-4 text-zinc-600">
